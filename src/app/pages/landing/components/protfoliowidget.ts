...
@Component({
    ...
    template: `
        <div id="portfolio" class="py-12 px-6 lg:px-20  mx-0 lg:mx-20">
            ...
            <!-- <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <div *ngFor="let image of images.slice(0, 6)" class="relative group">
                    <img [src]="image" alt="Portfolio Image" class="w-full h-64 object-cover rounded-lg shadow-lg transition-transform duration-300 transform group-hover:scale-105 group-hover:shadow-xl hover:cursor-pointer" (click)="openImage(image)" />
                </div>
            </div> -->
            <p-carousel 
                    [value]="images" 
